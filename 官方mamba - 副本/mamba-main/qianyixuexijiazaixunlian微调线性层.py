...
# 添加预训练模型路径参数，默认为指定路径
parser.add_argument('--pretrain-model', type=str, default=r'C:\Users\32468\Desktop\mamba双头\mamba双头尝试\迁移的权重0109\model_epoch_80_loss_0.0154.pth', help='Path to pre-trained model')
